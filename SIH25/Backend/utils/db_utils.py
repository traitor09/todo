...
MONGO_URI = os.environ.get("MONGO_CONNECTION_STRING", "mongodb+srv://user1:RRahul%4097050@cluster0.mrprgj8.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
